...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    ...
    <body background="<?php echo base_url();?>assets/img/logoakses.png" style="overflow:hidden">
                ...
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    <div class="block block-themed animated fadeIn">
                        <div class="block-header bg-primary">
                            ...
                            <h3 class="block-title text-center" style="color:red"><br></h3>
                        </div>
                        <div class="block-content block-content-full block-content-narrow">

                            <center>
                            <h1 class="h3 font-w600 push-30-t push-5" style="color:red">Sistem Informasi Inventory Telkom</h4>
                            </center>
                            <br><br><br><br>
                            <p style="color:red" class="text-center">Welcome, please login.</p>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material form-material-primary floating">
                                            ...
                                            <label for="login-username" style="color:black">Email</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <label class="css-input switch switch-sm switch-primary" style="color:white">
                                            <input type="checkbox" id="login-remember-me" name="login-remember-me" style="color:black"><span></span> Remember Me?
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">

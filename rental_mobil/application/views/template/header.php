...
<head>
  ...
  <title>Sistem | Inventory Telkom Akses</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>" class="logo">
      ...
      <span class="logo-lg"><b>Sistem</b> Inventory Telkom Akses</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo site_url('mobil');?>"><i class="fa fa-area-chart"></i> <span>Kendaraan</span></a></li>
        <li><a href="<?php echo site_url('fasilitas');?>"><i class="fa fa-area-chart"></i> <span>Fasilitas Kendaraan</span></a></li>  
